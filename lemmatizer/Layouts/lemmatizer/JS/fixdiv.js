...
$$.string.address = {
		b: "\u8bf7\u8f93\u5165\u82f1\u6587\u9996\u5b57\u6bcd\u6216\u2191\u2193\u9009\u62e9.",//请输入英文首字母或↑↓选择
        i: "\u8f93\u5165",//输入
        j: "\u6216\u2191\u2193\u9009\u62e9.",//或↑↓选择
        k: "\u82f1\u6587\u5168\u90e8\u6216\u9996\u5b57\u6bcd",//英文全部或首字母
        e: "\u8bf7\u8f93\u5165\u81f3\u5c11\u4e24\u4e2a\u5b57\u6bcd\u6216\u4e00\u4e2a\u5355\u8bcd.",//请输入至少两个字母或一个单词
        h: "",//
        o: "\u6309\u82f1\u6587\u9996\u5b57\u6bcd\u6392\u5e8f",//按英文首字母排序
        s: "\u5bf9\u4e0d\u8d77, \u627e\u4e0d\u5230: ",//对不起, 找不到
        l: "\u7ed3\u679c\u5171",//结果共
...
(function() {
    ...
    f = {
        ...
        cityListTagName: "ul",
        cityTagName: "span",
        hotData: {"A": "@1|Afghanistan@",'A': "@2|Argentina@3|Argentina@150|Argentina@245|Argentina"},
        hotTemplate: {
            ...
            title: '<div class="address_hotcity"><strong>\u0054\u0065\u0078\u0074\u0020\u0054\u0069\u0074\u006c\u0065</strong>：{$text}</div>',//Text Title
            ...
            if (f.hotData) {
                ...
                var a = f.hotTemplate.container.replaceWith({
                    text: [f.hotTemplate.title.replaceWith({
                        text: $$.module.address.source[o.source + "_keyWord"] || " \u0045\u006e\u0074\u0065\u0072\u0020\u0074\u0068\u0065\u0020\u0074\u0069\u0074\u006c\u0065\u0020\u006f\u0072\u0020\u0074\u0068\u0065\u0020\u0066\u0069\u0072\u0073\u0074\u0020\u006c\u0065\u0074\u0074\u0065\u0072"//（可直接英文全称或首字母）
