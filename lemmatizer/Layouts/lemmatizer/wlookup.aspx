...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="wlookup.aspx.cs" Inherits="lemmatizer.Layouts.lemmatizer.wlookup" DynamicMasterPageFile="~masterurl/default.master" %>
    ...
    <div id="inputDiv" class="rm_mainContent" runat="server">
            <div class="demo">
	            <div style="margin-left:4px;padding-top:5px;">
                    <div>是否一次性处理多篇：
                        <asp:RadioButtonList ID="radl" runat="server" RepeatDirection="Horizontal" RepeatLayout="Flow" AutoPostBack="true" OnSelectedIndexChanged="radl_SelectedIndexChanged">
                            <asp:ListItem Selected="True">否</asp:ListItem>
                            <asp:ListItem>是</asp:ListItem>
                        </asp:RadioButtonList>
                    </div>
                    <div>
                        <asp:Label ID="lb1" runat="server" Text="请输入多篇课文的分隔符：" Visible="false"></asp:Label>
                        <asp:TextBox ID="tbsplits" runat="server" Visible="false"></asp:TextBox>
                    </div>
                    <div id="selectch" runat="server" visible="true">
                        册:
                ...
                runat="server" rows="100" cols="80" class="ta" placeholder="请输入或者导入课文正文!" style="line-height:25px;font-size:12px;"></textarea>
                    ...
                    <div style="text-align:right;">
                        <asp:Button ID="btn1" runat="server" Text="处 理" OnClick="btn1_Click"></asp:Button>
