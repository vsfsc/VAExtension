...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AllProjects.aspx.cs" Inherits="Project.Layouts.Project.AllProjects" DynamicMasterPageFile="~masterurl/default.master" %>
    ...
    <div class="comments-SubmitProfile" id="allProjectDiv">
        ...
        <div class="comments-SubmitProfile-Titlebg">
            <div class="comments-SubmitProfile-Title">
                <h2 style="color: yellow">公示项目</h2>
            </div>
        </div>
        <div class="comments-SubmitProfile-content" style="border: solid 1px #8b4513">
            <asp:GridView ID="gvPublicProject" runat="server" AllowPaging="true" PageSize="7"
                ...
                PagerSettings-LastPageText="尾页" OnPageIndexChanging="gvPublicProject_PageIndexChanging">
                ...
                <Columns>
                    ...
                    <asp:HyperLinkField DataTextField="PName" HeaderText="项目名称" DataNavigateUrlFields="ProjectID"
                        DataNavigateUrlFormatString="PDetails.aspx?ProjectID={0}&pageTypeId=3" ItemStyle-HorizontalAlign="Left"
                        Target="_blank" />
                    <asp:BoundField DataField="CreatedDate" HeaderText="完成时间" ItemStyle-HorizontalAlign="Center" />
                    ...
                    <asp:HyperLinkField DataNavigateUrlFields="ProjectID" HeaderText="项目详情" Text="查看"
                        NavigateUrl="PDetails.aspx?ProjectID={0}&pageTypeId=3" ItemStyle-HorizontalAlign="Center" />
                </Columns>
            </asp:GridView>
        </div>
    </div>
