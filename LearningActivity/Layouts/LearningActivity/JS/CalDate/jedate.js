	...
	*/
    ...
    InitDate.prototype = {
        ...
        setHtml:function(opts, self) {
            ...
            var bothmsStr = !isformat ? '<ul class="botflex jedatehms"><li><em data-hms="24"></em><i>:</i></li><li><em data-hms="60"></em><i>:</i></li><li><em data-hms="60"></em></li></ul>' + '<div class="botflex jedatebtn"><span class="jedateclear" style="width:31%;">清空</span><span class="jedatetodaymonth" style="width:31%;">今天</span><span class="jedateok" style="width:31%;">确认</span></div>' :'<div class="botflex jedatebtn"><span class="jedateclear" style="width:31%;">清空</span><span class="jedatetodaymonth" style="width:31%;">本/</span><span class="jedateok" style="width:31%;">确认</span></div>';
            ...
            if (!isformat) {
                ...
                jeDt.text(QD(Cell + " .jedateym .jedateyearmonth")[0], arrTime[0] + "/" + jeDt.digit(arrTime[1]) + "/");
        ...
        onlyYMStr:function(y, m) {
            ...
            jeDt.each(jeDt.montharr, function(i, val) {
                onlyYM += "<li " + (m == val ? 'class="action"' :"") + ' data-onym="' + y + "-" + jeDt.digit(val) + '">' + y + "/" + jeDt.digit(val) + "/</li>";
            });
            return onlyYM;
        },
        ...
        getDateStr:function(y, m, d) {
            ...
            jeDt.text(QD(Cell + " .jedateyear")[0], y + "/").attr(QD(Cell + " .jedateyear")[0], "data-year", y);
            jeDt.text(QD(Cell + " .jedatemonth")[0], m + "/").attr(QD(Cell + " .jedatemonth")[0], "data-month", m);
            //是否显示节日
            ...
            //得到指定/的上个/最后一天传进来按 12/算
            function getPervMonthLastDay(year, month) {
                //当/就是  yue-1 也就是计算机里面的0-11/份,那么算上个/的最后一天就是当/的0天
            ...
            function eachYears(YY) {
                ...
                jeDt.each(new Array(15), function(i) {
                    if (i === 7) {
                        ...
                        eachStr += "<li " + (getyear == YY ? 'class="action"' :"") + ' data-y="' + YY + '">' + YY + "/</li>";
                    } else {
                        eachStr += '<li data-y="' + (YY - 7 + i) + '">' + (YY - 7 + i) + "/</li>";
                    }
                });
                return eachStr;
            }
            function setYearMonth(YY, ymlen) {
                ...
                if (ymlen == 12) {
                    jeDt.each(jeDt.montharr, function(i, val) {
                        ...
                        ymStr += "<li " + (getmonth == val ? 'class="action"' :"") + ' data-m="' + val + '">' + val + "/</li>";
                    });
