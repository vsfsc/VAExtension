...
<%@ Page Language="C#" AutoEventWireup="true" Inherits="ContestDll.WorksPartition" DynamicMasterPageFile="~masterurl/default.master" %>
...
<AlternatingRowStyle HorizontalAlign="Left"></AlternatingRowStyle>
    ...
    <table cellpadding="3" cellspacing="0" border="0" width="800px" style="font-size: 14px;
        ...
        <tr>
            <td class="tdone">
                <asp:Label ID="albl" runat="server" Text="作品名称："></asp:Label>
            </td>
            <td>
                <asp:TextBox ID="txtWorksName" runat="server" CssClass="txtcss"></asp:TextBox>
            </td>
            <td class="tdone">
                <asp:Label ID="slbl" runat="server" Text="作品类别："></asp:Label>
            </td>
            <td>
        ...
        <tr>
            <td colspan="5" style="border: 1px solid #999; background-color: #ffffe1">
